...
public class FruitBoxMain {
    ...
    public static void main(String[] args) {
        ...
        fruitBox1.store(new Apple("맛있는 사과", 10000, "red", 5));
        fruitBox1.store(new Apple("덜 맛있는 사과", 5000, "purple", 3));

        FruitBox<Banana> fruitBox2 = new FruitBox<>();
        fruitBox2.store(new Banana("썩은 바나나", 15000, "black", 2));
        fruitBox2.store(new Banana("맛있는 바나나", 8000, "yellow", 5));
        fruitBox2.store(new Banana("덜 익은 바나나", 10000, "green", 1));
